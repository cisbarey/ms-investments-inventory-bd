...
@Component
public class QueryByTickerHelper implements IQueryByTickerHelper {

	@Autowired
	private DetailFundsHelper detailFundsHelper;

	@Override
	public QueryByTickerRequestClientBean toRequest(QueryByTickerRequestBean requestBean) {
		QueryByTickerRequestClientBean requestClientBean = new QueryByTickerRequestClientBean();
		requestClientBean.setTicker(requestBean.getTicker().trim());
		requestClientBean.setIsins(requestBean.getIsins());
		return requestClientBean;
	}

	@Override
	public QueryByTickerResponseBean toResponse(QueryByTickerResponseClientBean responseClientBean) {
		QueryByTickerResponseBean responseBean = new QueryByTickerResponseBean();
