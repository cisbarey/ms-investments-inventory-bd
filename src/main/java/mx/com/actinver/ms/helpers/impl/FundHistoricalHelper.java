...
@Component
public class FundHistoricalHelper implements IEntityHelper<FundsClientBean, FundsHistoricalClientBean> {

    @Override
    public List<FundsHistoricalClientBean> toEntityAll(List<FundsClientBean> clientBean) {
        List<FundsHistoricalClientBean> beans = new ArrayList<>();
        if (clientBean != null && !clientBean.isEmpty()) {
            for (int i = 0; i < clientBean.size(); i++) {
                FundsHistoricalClientBean bean = new FundsHistoricalClientBean();
    ...
    @Override
    public FundsClientBean toBean(FundsHistoricalClientBean clientBean) {
        ...
        bean.setCumulativeReturn15Yr(clientBean.getCumulativeReturn5Yr());
    ...
    @Override
    public FundsHistoricalClientBean toEntity(FundsClientBean requestBean) {
        Gson gson = new Gson();
        return gson.fromJson(gson.toJson(requestBean), FundsHistoricalClientBean.class);
